...
#ifndef HPP_PERSO_DEPRECATED_HH
# define HPP_PERSO_DEPRECATED_HH
...
//  void foo () HPP_PERSO_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar HPP_PERSO_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a HPP_PERSO_DEPRECATED = 0;
//
...
# ifdef __GNUC__
#  define HPP_PERSO_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define HPP_PERSO_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define HPP_PERSO_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! HPP_PERSO_DEPRECATED_HH
